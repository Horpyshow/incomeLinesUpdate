...
class AnnualBudgetPerformanceAnalyzer {
    ...
    public function getQuarterlyPerformance($year) {
        ...
        foreach ($quarters as $quarter => $info) {
            ...
            foreach ($info['months'] as $month) {
                ...
                $quarter_budget += $budget_result['monthly_budget'] ?? 0;
                $quarter_achieved += $achieved_result['achieved'] ?? 0;
            }
    ...
    public function getPerformanceInsights($year) {
        ...
        $worst_month = null;
        $best_percentage = 0;
        $worst_percentage = PHP_FLOAT_MAX;
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <h1 class="text-xl font-bold text-gray-900">Annual Budget Performance Summary</h1>
                </div>
