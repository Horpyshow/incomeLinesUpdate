...
<div class="col-sm-7">
		...
		<table>
			<tr>
				...
				<?php
					...
					$query .= "WHERE service_charge_paid = '' ";
	...
	<table class="table table-bordered">	
		<tr>
			<div class="form-group form-group-sm">
				</br><span class="col-sm-10" style="font-weight:bold; text-align:center;">Transaction Account</span>
			</div>
		
			<!-- Select Basic -->			   
			<div class="form-group form-group-sm"> 
				<div class="col-sm-6 col-sm-offset-2 selectContainer">
					<div class="input-group">
