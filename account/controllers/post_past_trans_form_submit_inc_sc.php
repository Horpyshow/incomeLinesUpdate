...
if ( isset($_POST['btn_post']) ) {
  ...
  // clean user inputs to prevent sql injections
	...
	$query .= "AND payment_category = 'Service Charge' ";
	...
	$query_n .= "AND payment_category = 'Service Charge' ";
...
if (!$error) {
	...
	$now = date('Y-m-d H:i:s');
		...
		$dquery = "INSERT INTO $db_debit_table (id,acct_id,shop_no,date,ref_cheque_no,journal_no,receipt_no,trans_desc,debit_amount,approval_status) VALUES('$txref','$debit_account','$shop_no','$date_of_payment','$ref_cheque_no','$journal_no','$receipt_no','$transaction_desc','$amount_paid','$approval_status')";
		$debit_query = @mysqli_query($dbcon, $dquery);
		
	
		$cquery = "INSERT INTO $db_credit_table (id,acct_id,shop_no,date,ref_cheque_no,journal_no,receipt_no,trans_desc,credit_amount,approval_status) VALUES('$txref','$credit_account','$shop_no','$date_of_payment','$ref_cheque_no','$journal_no','$receipt_no','$transaction_desc','$amount_paid','$approval_status')";
		$credit_query = @mysqli_query($dbcon, $cquery);
				
		
		$ca_query1 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_service_charge,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','$shop_id','$shop_no','$customer','$date_of_payment','$falling_due_month','$month_year1','$amount1','$receipt_no','$expected_monthly_sc','$payment_status1','$now','$posting_officer_id','$posting_officer_name')";
		$ca_query1 = @mysqli_query($dbcon, $ca_query1);
		
		if($month2 != "" && $year2 != "" && $amount2 != ""){
			$ca_query2 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_service_charge,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','$shop_id','$shop_no','$customer','$date_of_payment','$falling_due_month','$month_year2','$amount2','$receipt_no','$expected_monthly_sc','$payment_status2','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query2 = @mysqli_query($dbcon, $ca_query2);
		}
		
		if($month3 != "" && $year3 != "" && $amount3 != ""){
			$ca_query3 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_service_charge,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','$shop_id','$shop_no','$customer','$date_of_payment','$falling_due_month','$month_year3','$amount3','$receipt_no','$expected_monthly_sc','$payment_status3','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query3 = @mysqli_query($dbcon, $ca_query3);
		}
		
		if($month4 != "" && $year4 != "" && $amount4 != ""){
			$ca_query4 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_service_charge,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','$shop_id','$shop_no','$customer','$date_of_payment','$falling_due_month','$month_year4','$amount4','$receipt_no','$expected_monthly_sc','$payment_status4','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query4 = @mysqli_query($dbcon, $ca_query4);
		}

		if($month5 != "" && $year5 != "" && $amount5 != ""){
			$ca_query5 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_service_charge,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','$shop_id','$shop_no','$customer','$date_of_payment','$falling_due_month','$month_year5','$amount5','$receipt_no','$expected_monthly_sc','$payment_status5','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query5 = @mysqli_query($dbcon, $ca_query5);
		}
		
		if($month6 != "" && $year6 != "" && $amount6 != ""){
			$ca_query6 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_service_charge,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','$shop_id','$shop_no','$customer','$date_of_payment','$falling_due_month','$month_year6','$amount6','$receipt_no','$expected_monthly_sc','$payment_status6','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query6 = @mysqli_query($dbcon, $ca_query6);
		}
		
		if($month7 != "" && $year7 != "" && $amount7 != ""){
			$ca_query7 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_service_charge,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','$shop_id','$shop_no','$customer','$date_of_payment','$falling_due_month','$month_year7','$amount7','$receipt_no','$expected_monthly_sc','$payment_status7','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query7 = @mysqli_query($dbcon, $ca_query7);
		}
		
		if($month8 != "" && $year8 != "" && $amount8 != ""){
			$ca_query8 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_service_charge,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','$shop_id','$shop_no','$customer','$date_of_payment','$falling_due_month','$month_year8','$amount8','$receipt_no','$expected_monthly_sc','$payment_status8','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query8 = @mysqli_query($dbcon, $ca_query8);
		}
		
		if($month9 != "" && $year9 != "" && $amount9 != ""){
			$ca_query9 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_service_charge,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','$shop_id','$shop_no','$customer','$date_of_payment','$falling_due_month','$month_year9','$amount9','$receipt_no','$expected_monthly_sc','$payment_status9','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query9 = @mysqli_query($dbcon, $ca_query9);
		}
		
		if($month10 != "" && $year10 != "" && $amount10 != ""){
			$ca_query10 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_service_charge,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','$shop_id','$shop_no','$customer','$date_of_payment','$falling_due_month','$month_year10','$amount10','$receipt_no','$expected_monthly_sc','$payment_status10','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query10 = @mysqli_query($dbcon, $ca_query10);
		}
			
		if($month11 != "" && $year11 != "" && $amount11 != ""){
			$ca_query11 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_service_charge,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','$shop_id','$shop_no','$customer','$date_of_payment','$falling_due_month','$month_year11','$amount11','$receipt_no','$expected_monthly_sc','$payment_status11','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query11 = @mysqli_query($dbcon, $ca_query11);
		}
		
		if($month12 != "" && $year12 != "" && $amount12 != ""){
			$ca_query12 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_service_charge,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','$shop_id','$shop_no','$customer','$date_of_payment','$falling_due_month','$month_year12','$amount12','$receipt_no','$expected_monthly_sc','$payment_status12','$now','$posting_officer_id','$posting_officer_name')";
	...
	if ($credit_query)
		{
			...
			window.location.href='post_past_trans_sc.php';
			</script>
			<?php
		}
		else
