<form  method="post" id="form" class="form-horizontal" action="cash_remittance_processing.php" autocomplete="off">
	...
	<div class="form-group form-group-sm">
		...
		<div class="col-sm-6">
			<div class="input-group input-append">
				<input type="text" class="form-control input-sm" name="date_of_payment" placeholder="Date of Payment" value="<?php echo @$yesterday; ?>" readonly />
	...
	<div class="form-group form-group-sm">
		...
		<div class="col-sm-6 inputGroupContainer">
			<div class="input-group">
				...
				<input type="text" name="amount_paid" id="amount_paid" class="form-control input-sm" placeholder="Amount Paid" value="<?php if (isset($_POST['amount_paid'])) echo @$amount_paid; ?>" maxlength="25" required />
			</div>
		</div>
	</div>
	...
	<div class="text-center">
		<div>
			<button type="submit" id="btn_post" name="btn_post" class="btn btn-sm btn-success">Post Sunday Remittance <span class="glyphicon glyphicon-send"></span></button>
