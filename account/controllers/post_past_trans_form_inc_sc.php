...
<div class="col-sm-7">
	...
	<table class="table table-bordered">	
		<tr>
			...
			<!-- Select Basic -->			   
			<div class="form-group form-group-sm"> 
				<div class="col-sm-5 col-sm-offset-3 selectContainer">
					<div class="input-group">
	...
	<div class="row">
				...
				<tr> 
					<td colspan="3">
						...
						<div class="form-group form-group-sm">
							<label class="control-label col-sm-3" for="monthly_expected">Monthly Expected:</label>
							<div class="col-sm-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon">&#8358;</span>
									<input type="text" name="monthly_expected" id="monthly_expected" class="form-control input-sm" onBlur="loadCalc()" value="<?php if (isset($_POST["monthly_expected"])) echo @$expected_monthly_sc; ?>" readonly />
								</div>
							</div>
						</div>
						...
						<div class="form-group form-group-sm">
							<label class="control-label col-sm-3" for="monthly_expected">Total Payable:</label>
							<div class="col-sm-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon">&#8358;</span>
									<input type="text" name="yearly_expected" id="yearly_expected" class="form-control input-sm" onBlur="loadCalc()" value="<?php if (isset($_POST["yearly_expected"])) echo @$expected_sc; ?>" readonly />
								</div>
							</div>
						</div>
					</td>
						...
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-6 inputGroupContainer">
								<div class="input-group">
									...
									<input type="text" name="transaction_desc" class="form-control input-sm" placeholder="Transaction description" value="Service Charge Payment" readonly />
								</div>
							</div>
						</div>
