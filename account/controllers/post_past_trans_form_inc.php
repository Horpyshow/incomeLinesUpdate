...
<div class="col-sm-5">
		...
		<table>
			<tr>
				...
				<?php
					...
					//$query .= "AND (renewal_approval != 'Pending' AND edit_approval !='Pending' AND status != 'Disabled') ";
					//$query .= "AND staff_id =".$staff['user_id'];
					$query .= " ORDER BY shop_no ASC";
					$result_set = @mysqli_query($dbcon, $query); 
				?>
				
				<div class="form-group form-group-sm"> 
				  <label for="shop_id" class="col-sm-2 control-label">Space No:</label>
							...
							<select name="shop_id" class="form-control selectpicker" id="shop_id">
							  <option value="">Select...</option>
								<?php
									...
									{
										?>
										<option value="<?php echo $shop['id']; ?>"><?php echo $shop['shop_no'].'...'.$shop['customer_name'].'...'.$shop['facility_type'].'...'.$shop['location']; ?></option>
										<?php
									} 
								?>
							</select>
			...
			<div id="row_month1">
			<div class="form-group form-group-sm">
				<label for="year1" class="col-sm-2 control-label">Tenure 1:</label>
				<div class="col-sm-5 selectContainer">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
						<select name="year1" class="form-control selectpicker" id="year1" required></select>
					</div>
				</div>
			...
			<div id="row_month2">
			<div class="form-group form-group-sm">
				<label for="year2" class="col-sm-2 control-label">Tenure 2:</label>
				<div class="col-sm-5 selectContainer">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
						<select name="year2" class="form-control selectpicker" id="year2"></select>
					</div>
				</div>
			...
			<div id="row_month3">
			<div class="form-group form-group-sm">
				<label for="year3" class="col-sm-2 control-label">Tenure 3:</label>
				<div class="col-sm-5 selectContainer">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
						<select name="year3" class="form-control selectpicker" id="year3"></select>
					</div>
				</div>
			...
			<div id="row_month4">
			<div class="form-group form-group-sm">
				<label for="year4" class="col-sm-2 control-label">Tenure 4:</label>
				<div class="col-sm-5 selectContainer">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
						<select name="year4" class="form-control selectpicker" id="year4"></select>
					</div>
				</div>
			...
			<div id="row_month5">
			<div class="form-group form-group-sm">
				<label for="year5" class="col-sm-2 control-label">Tenure 5:</label>
				<div class="col-sm-5 selectContainer">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
						<select name="year5" class="form-control selectpicker" id="year5"></select>
					</div>
				</div>
			...
			<div id="row_month6">
			<div class="form-group form-group-sm">
				<label for="year6" class="col-sm-2 control-label">Tenure 6:</label>
				<div class="col-sm-5 selectContainer">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
						<select name="year6" class="form-control selectpicker" id="year6"></select>
					</div>
				</div>
			...
			<div id="row_month7">
			<div class="form-group form-group-sm">
				<label for="year7" class="col-sm-2 control-label">Tenure 7:</label>
				<div class="col-sm-5 selectContainer">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
						<select name="year7" class="form-control selectpicker" id="year7"></select>
					</div>
				</div>
			...
			<div id="row_month8">
			<div class="form-group form-group-sm">
				<label for="year8" class="col-sm-2 control-label">Tenure 8:</label>
				<div class="col-sm-5 selectContainer">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
						<select name="year8" class="form-control selectpicker" id="year8"></select>
					</div>
				</div>
			...
			<div id="row_month9">
			<div class="form-group form-group-sm">
				<label for="year9" class="col-sm-2 control-label">Tenure 9:</label>
				<div class="col-sm-5 selectContainer">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
						<select name="year9" class="form-control selectpicker" id="year9"></select>
					</div>
				</div>
			...
			<div id="row_month10">
			<div class="form-group form-group-sm">
				<label for="year10" class="col-sm-2 control-label">Tenure 10:</label>
				<div class="col-sm-5 selectContainer">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
						<select name="year10" class="form-control selectpicker" id="year10"></select>
					</div>
				</div>
			...
			<div id="row_month11">
			<div class="form-group form-group-sm">
				<label for="year11" class="col-sm-2 control-label">Tenure 11:</label>
				<div class="col-sm-5 selectContainer">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
						<select name="year11" class="form-control selectpicker" id="year11"></select>
					</div>
				</div>
			...
			<div id="row_month12">
			<div class="form-group form-group-sm">
				<label for="year12" class="col-sm-2 control-label">Tenure 12:</label>
				<div class="col-sm-5 selectContainer">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
						<select name="year12" class="form-control selectpicker" id="year12"></select>
					</div>
				</div>
	...
	<table class="table table-bordered">	
		<tr>
			...
			<!-- Select Basic -->			   
			<div class="form-group form-group-sm"> 
				<div class="col-sm-8 col-sm-offset-2 selectContainer">
					<div class="input-group">
					...
					<td colspan="3">
						...
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-8 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
									<input type="text" name="location" id="location" class="form-control input-sm" placeholder="" value="<?php if (isset($_POST["location"])) echo strtoupper(@$location); ?>" onBlur="loadCalc()" readonly />
								</div>
							</div>
						</div>
						...
						<!-- Text input-->			
						<div class="form-group form-group-sm">
							<label for="facility_type" class="control-label col-md-3">Facility Type:</label>
							<div class="col-sm-5 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
									<input type="text" name="facility_type" id="facility_type" class="form-control input-sm" placeholder="" value="<?php if (isset($_POST["facility_type"])) echo @$facility_type; ?>" onBlur="loadCalc()" readonly />
								</div>
							</div>
						</div>
						...
						<!-- Select Basic -->			   
						<div class="form-group form-group-sm"> 
						  <label for="payment_type" class="col-md-3 control-label">Type of Payment:</label>
						...
						<!-- Text input-->			
						<div class="form-group form-group-sm">
							<label for="cheque_no" class="control-label col-md-3">Cheque No:</label>
						...
						<!-- Text input-->			
						<div class="form-group form-group-sm">
							<label for="teller_no" class="control-label col-md-3">Teller No:</label>
							<div class="col-md-5 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-tag"></i></span>
						...
						<div class="form-group form-group-sm">
							<label class="col-sm-3 control-label">Date on Receipt:</label>
							<div class="col-sm-5 date">
					...
					<td colspan="3">
						...
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-6 inputGroupContainer">
								<div class="input-group">
									...
									<input type="text" name="transaction_desc" class="form-control input-sm" placeholder="Transaction description" value="Rent Payment" readonly />
								</div>
							</div>
						</div>
						...
						<div class="form-group form-group-sm">
							...
							<div class="col-md-7 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
									<input type="text" name="add_transaction_desc" class="form-control input-sm" placeholder="Transfer ONLY" value="<?php if (isset($_POST['add_transaction_desc'])) echo @$post['transaction_desc']; ?>" maxlength="100" />
								</div>
							</div>
						</div>
