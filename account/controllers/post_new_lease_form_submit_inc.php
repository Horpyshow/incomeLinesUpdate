...
if ( isset($_POST['btn_post']) ) {
	...
	$month1 = $_POST['month1'];
	$int_year1 = $_POST['year1'];
	$amount1 = $_POST['amount1'];
	$year1 = $_POST['month_year1'];
	...
	$month2 = $_POST['month2'];
	$int_year2 = $_POST['year2'];
	$amount2 = $_POST['amount2'];
	$year2 = $_POST['month_year2'];
	...
	$month3 = $_POST['month3'];
	$int_year3 = $_POST['year3'];
	$amount3 = $_POST['amount3'];
	$year3 = $_POST['month_year3'];
	...
	$month4 = $_POST['month4'];
	$int_year4 = $_POST['year4'];
	$amount4 = $_POST['amount4'];
	$year4 = $_POST['month_year4'];
	...
	$month5 = $_POST['month5'];
	$int_year5 = $_POST['year5'];
	$amount5 = $_POST['amount5'];
	$year5 = $_POST['month_year5'];
	...
	$month6 = $_POST['month6'];
	$int_year6 = $_POST['year6'];
	$amount6 = $_POST['amount6'];
	$year6 = $_POST['month_year6'];
	...
	$month7 = $_POST['month7'];
	$int_year7 = $_POST['year7'];
	$amount7 = $_POST['amount7'];
	$year7 = $_POST['month_year7'];
	...
	$month8 = $_POST['month8'];
	$int_year8 = $_POST['year8'];
	$amount8 = $_POST['amount8'];
	$year8 = $_POST['month_year8'];
	...
	$month9 = $_POST['month9'];
	$int_year9 = $_POST['year9'];
	$amount9 = $_POST['amount9'];
	$year9 = $_POST['month_year9'];
	...
	$int_year10 = $_POST['year10'];
	$amount10 = $_POST['amount10'];
	$year10 = $_POST['month_year10'];
	...
	$int_year11 = $_POST['year11'];
	$amount11 = $_POST['amount11'];
	$year11 = $_POST['month_year11'];
	...
	$int_year12 = $_POST['year12'];
	$amount12 = $_POST['amount12'];
	$year12 = $_POST['month_year12'];
  ...
  // clean user inputs to prevent sql injections
	...
	$cbal_query = "SELECT * FROM customers_new_registration ";
...
if (!$error) {
	...
	$now = date('Y-m-d H:i:s');
		...
		$ca_query1 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_rent,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','','$shop_no','$customer','$date_of_payment','$falling_due_month','$year1','$amount1','$receipt_no','$expected_rent','$payment_status1','$now','$posting_officer_id','$posting_officer_name')";
		$ca_query1 = @mysqli_query($dbcon, $ca_query1);
		
		if($year2 != "" && $amount2 != ""){
			$ca_query2 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_rent,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','','$shop_no','$customer','$date_of_payment','$falling_due_month','$year2','$amount2','$receipt_no','$expected_rent','$payment_status2','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query2 = @mysqli_query($dbcon, $ca_query2);
		}
		
		if($year3 != "" && $amount3 != ""){
			$ca_query3 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_rent,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','','$shop_no','$customer','$date_of_payment','$falling_due_month','$year3','$amount3','$receipt_no','$expected_rent','$payment_status3','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query3 = mysqli_query($dbcon, $ca_query3);
		}
		
		if($year4 != "" && $amount4 != ""){
			$ca_query4 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_rent,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','','$shop_no','$customer','$date_of_payment','$falling_due_month','$year4','$amount4','$receipt_no','$expected_rent','$payment_status4','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query4 = @mysqli_query($dbcon, $ca_query4);
		}

		if($year5 != "" && $amount5 != ""){
			$ca_query5 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_rent,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','','$shop_no','$customer','$date_of_payment','$falling_due_month','$year5','$amount5','$receipt_no','$expected_rent','$payment_status5','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query5 = @mysqli_query($dbcon, $ca_query5);
		}
		
		if($year6 != "" && $amount6 != ""){
			$ca_query6 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_rent,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','','$shop_no','$customer','$date_of_payment','$falling_due_month','$year6','$amount6','$receipt_no','$expected_rent','$payment_status6','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query6 = @mysqli_query($dbcon, $ca_query6);
		}
		
		
		if($year7 != "" && $amount7 != ""){
			$ca_query7 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_rent,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','','$shop_no','$customer','$date_of_payment','$falling_due_month','$year7','$amount7','$receipt_no','$expected_rent','$payment_status7','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query7 = @mysqli_query($dbcon, $ca_query7);
		}
		
		if($year8 != "" && $amount8 != ""){
			$ca_query8 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_rent,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','','$shop_no','$customer','$date_of_payment','$falling_due_month','$year8','$amount8','$receipt_no','$expected_rent','$payment_status8','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query8 = @mysqli_query($dbcon, $ca_query8);
		}
		
		if($year9 != "" && $amount9 != ""){
			$ca_query9 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_rent,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','','$shop_no','$customer','$date_of_payment','$falling_due_month','$year9','$amount9','$receipt_no','$expected_rent','$payment_status9','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query9 = @mysqli_query($dbcon, $ca_query9);
		}
		
		if($year10 != "" && $amount10 != ""){
			$ca_query10 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_rent,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','','$shop_no','$customer','$date_of_payment','$falling_due_month','$year10','$amount10','$receipt_no','$expected_rent','$payment_status10','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query10 = @mysqli_query($dbcon, $ca_query10);
		}
		
		
		if($year11 != "" && $amount11 != ""){
			$ca_query11 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_rent,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','','$shop_no','$customer','$date_of_payment','$falling_due_month','$year11','$amount11','$receipt_no','$expected_rent','$payment_status11','$now','$posting_officer_id','$posting_officer_name')";
			$ca_query11 = @mysqli_query($dbcon, $ca_query11);
		}
		
		if($year12 != "" && $amount12 != ""){
			$ca_query12 = "INSERT INTO $db_collection_table (id,trans_id,shop_id,shop_no,customer_name,date_of_payment,falling_due_month,payment_month,amount_paid,receipt_no,expected_rent,payment_status,posting_time,posting_officer_id,posting_officer_name) VALUES('','$txref','','$shop_no','$customer','$date_of_payment','$falling_due_month','$year12','$amount12','$receipt_no','$expected_rent','$payment_status12','$now','$posting_officer_id','$posting_officer_name')";
