		...
		<div class="row">
			<div class="table-responsive">
				<table class="table table-hover">
					<tr>
						<td><a href="payments_past.php?income_line=general">General</a></td>
					</tr>
					<tr>
						<td><a href="payments_past.php?income_line=abattoir">Abattoir</a></td>
					</tr>
					<tr>
						<td><a href="payments_past.php?income_line=car_loading">Car Loading Ticket</a></td>
					</tr>
					<tr>
						<td><a href="payments_past.php?income_line=car_park">Car Park Ticket</a></td>
					</tr>
					<tr>
						<td><a href="payments_past.php?income_line=hawkers">Hawkers Ticket</a></td>
					</tr>
					<tr>
						<td><a href="payments_past.php?income_line=wheelbarrow">WheelBarrow Ticket</a></td>
					</tr>
					<tr>
						<td><a href="payments_past.php?income_line=daily_trade">Daily Trade</a></td>
					</tr>
					<tr>
						<td><a href="payments_past.php?income_line=toilet_collection">Toilet Collection</a></td>
					</tr>
				</table>
			</div>
		</div>		
				...
				<div class="container-fluid">
					<div class="col-md-12">
						...
						<?php
							...
							echo '<a href="payments.php" class="btn btn-sm btn-success">Post Current Payments</a>';
						?>
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="t1">
						...
						<?php
							if(isset($_GET["income_line"])) {
								if ($income_line == "general") {
									include 'payments_past/general_form_inc.php';
								} elseif ($income_line == "car_sticker") {
									include 'payments_past/car_sticker_inc.php';
								} elseif ($income_line == "abattoir") {
									include 'payments_past/abattoir_form_inc.php';
								} elseif ($income_line == "car_loading") {
									include 'payments_past/car_loading_form_inc.php';
								} elseif ($income_line == "car_park") {
									include 'payments_past/car_park_form_inc.php';
								} elseif ($income_line == "hawkers") {
									include 'payments_past/hawkers_form_inc.php';
								} elseif ($income_line == "wheelbarrow") {
									include 'payments_past/wheelbarrow_form_inc.php';
								} elseif ($income_line == "daily_trade") {
									include 'payments_past/daily_trade_form_inc.php';
								} elseif ($income_line == "toilet_collection") {
									include 'payments_past/toilet_collection_form_inc.php';
								} elseif ($income_line == "loading") {
									include 'payments_past/loading_form_inc.php';
								} elseif ($income_line == "overnight_parking") {
									include 'payments_past/overnight_parking_form_inc.php';
								} else {
	...
	<div class="col-md-2">
		...
		<div class="row">
			<div class="table-responsive">
				<table class="table table-hover">
					<tr class="text-right">
						<td><a href="payments_past.php?income_line=car_sticker">Car Sticker</a></td>
					</tr>
					<tr class="text-right">
						<td><a href="payments_past.php?income_line=loading">Loading & Offloading</a></td>
					</tr>
					<tr class="text-right">
						<td><a href="payments_past.php?income_line=overnight_parking">Overnight Parking</a></td>
					</tr>
				</table>
			</div>
		</div>		
