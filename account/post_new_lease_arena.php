...
$sub_prefix = "";
$sub_suffix = "";
$page_title = "Post New Lease {$project} Transactions - Wealth Creation ERP";

include ('controllers/post_new_lease_form_submit_inc_arena.php');
?>
<!DOCTYPE html>
<html>
	<head>
...
$(document).ready(function(){
	...
	$("#shop_id").change(function() {    
		...
		$.ajax({
			url: 'get_new_lease_customer_info_r.php',
			dataType: "json",
			data: dataString,  
			cache: false,
			success: function(customerData) {
			   if(customerData) {
					...
					$("#ref_no").val(customerData.ref_no);
...
<div class="container-fluid">
	<div class="col-md-12">
		<div class="row">
			<div class="page-header">
				<div class="container-fluid">
					<div class="col-md-7">
						<h2>
							<strong>New Lease <?php echo $project; ?> Payment Dashboard</strong>
						</h2>
					</div>
					...
					<div class="col-md-5">
						...
						<?php
							...
							echo '<h4><a href="acct_view_trans_sc.php?staff_id='.$session_id.'"><span style="color:#ec7063; font-weight:bold;">&#8358 '.$total_till.'</span> Till Balance | ';
						?>
		...
		<div class="row">
			<?php include ('controllers/post_new_lease_form_inc_arena.php'); ?>
		</div>
	</div>			
</div>
