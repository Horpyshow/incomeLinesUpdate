...
if ($debit_query)
	{
		...
		window.location.href='payments_sunday.php';
		</script>
		<?php
	}
	else
...
<script type="text/javascript">
	...
	var total_ticket_amount = (no_of_ticket * 600);
...
<div class="container-fluid">
		...
		<div class="row">
			<div class="table-responsive">
				<table class="table table-hover">
					<tr>
						<td><a href="payments_sunday.php?income_line=general" oncontextmenu="return false;">General</a></td>
					</tr>
					<tr>
						<td><a href="payments_sunday.php?income_line=abattoir" oncontextmenu="return false;">Abattoir</a></td>
					</tr>
					<tr>
						<td><a href="payments_sunday.php?income_line=car_loading" oncontextmenu="return false;">Car Loading Ticket</a></td>
					</tr>
					<tr>
						<td><a href="payments_sunday.php?income_line=car_park" oncontextmenu="return false;">Car Park Ticket</a></td>
					</tr>
					<tr>
						<td><a href="payments_sunday.php?income_line=hawkers" oncontextmenu="return false;">Hawkers Ticket</a></td>
					</tr>
					<tr>
						<td><a href="payments_sunday.php?income_line=wheelbarrow" oncontextmenu="return false;">WheelBarrow Ticket</a></td>
					</tr>
					<tr>
						<td><a href="payments_sunday.php?income_line=daily_trade" oncontextmenu="return false;">Daily Trade</a></td>
					</tr>
					<tr>
						<td><a href="payments_sunday.php?income_line=toilet_collection" oncontextmenu="return false;">Toilet Collection</a></td>
					</tr>
				</table>
			</div>
		</div>		
	...
	<div class="col-md-8">
		<div class="row">
				<div class="container-fluid">
					<div class="col-md-12">
						<h3><span style="color:#ec7063; font-weight:bold;">Sunday Market Payments Dashboard</span></h3>
						<h4>
						<?php
							if(isset($_SESSION['staff']) ) {
								$staffquery = "SELECT * FROM staffs WHERE user_id=".$_SESSION['staff'];
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="t1">
						...
						<?php
							if(isset($_GET["income_line"])) {
								if ($income_line == "general") {
									include 'payments_sunday/general_form_inc.php';
								} elseif ($income_line == "car_sticker") {
									include 'payments_sunday/car_sticker_inc.php';
								} elseif ($income_line == "abattoir") {
									include 'payments_sunday/abattoir_form_inc.php';
								} elseif ($income_line == "car_loading") {
									include 'payments_sunday/car_loading_form_inc.php';
								} elseif ($income_line == "car_park") {
									include 'payments_sunday/car_park_form_inc.php';
								} elseif ($income_line == "hawkers") {
									include 'payments_sunday/hawkers_form_inc.php';
								} elseif ($income_line == "wheelbarrow") {
									include 'payments_sunday/wheelbarrow_form_inc.php';
								} elseif ($income_line == "daily_trade") {
									include 'payments_sunday/daily_trade_form_inc.php';
								} elseif ($income_line == "toilet_collection") {
									include 'payments_sunday/toilet_collection_form_inc.php';
								} elseif ($income_line == "loading") {
									include 'payments_sunday/loading_form_inc.php';
								} elseif ($income_line == "overnight_parking") {
									include 'payments_sunday/overnight_parking_form_inc.php';
								} else {
	...
	<div class="col-md-2">
		...
		<div class="row">
			<div class="table-responsive">
				<table class="table table-hover">
					<tr class="text-right">
						<td><a href="payments_sunday.php?income_line=car_sticker" oncontextmenu="return false;">Car Sticker</a></td>
					</tr>
					<tr class="text-right">
						<td><a href="payments_sunday.php?income_line=loading" oncontextmenu="return false;">Loading & Offloading</a></td>
					</tr>
					<tr class="text-right">
						<td><a href="payments_sunday.php?income_line=overnight_parking" oncontextmenu="return false;">Overnight Parking</a></td>
					</tr>
				</table>
			</div>
		</div>		
