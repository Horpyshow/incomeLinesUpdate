			...
			<td colspan="3">
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							...
							<input type="text" name="receipt_no" class="form-control input-sm" placeholder="Receipt No" pattern="^\d{7}$" value="<?php if (isset($repost_id)) echo @$receipt_no; ?>" maxlength="7" required />
						</div>
					</div>
				</div>
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon">&#8358;</span>
							<input type="text" id="amount_paid" name="amount_paid" class="form-control input-sm" placeholder="Amount Remitted" value="<?php if (isset($repost_id)) echo @$amount_paid; ?>" maxlength="20" required />
						</div>
					</div>
				</div>
