				...
				<div class="form-group form-group-sm">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							...
							<input type="text" id="amount_paid" name="amount_paid" class="form-control input-sm" placeholder="Amount Remitted" value="60000" maxlength="20" onBlur="loadCalc()" readonly />
						</div>
					</div>
				</div>
			</td>
								...
								<select name="credit_account" class="form-control selectpicker" id="credit_account" required>
								  <option value="">Select credit account</option>
									<?php
										...
										$cquery .= "AND acct_alias = 'car_sticker' ";
