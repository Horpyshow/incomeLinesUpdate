	...
	<fieldset>
		...
		<table class="table table-bordered">
			...
			<td colspan="3">
				...
				<div class="form-group form-group-sm"> 
				  <label for="ticket_category" class="col-md-4 control-label">Ticket Category:</label>
					<div class="col-md-4 selectContainer">
						<div class="input-group">
							<span class="input-group-addon">&#8358;</span>
							<select name="ticket_category" class="form-control selectpicker" id="ticket_category" onBlur="loadCalc()" required >
