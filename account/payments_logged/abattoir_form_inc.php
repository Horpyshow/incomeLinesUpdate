<form  method="post" id="form" class="form-horizontal" action="post_logged_trans_others.php?repost_id=<?php echo $repost_id; ?>" autocomplete="off">
	...
	<fieldset>
		...
		<input type="hidden" name="credit_alias" value="<?php echo $alias; ?>" maxlength="50">
		...
		<table class="table table-bordered">
			<tr> 
			<td colspan="3">
				<?php include 'payments_logged/remittance_form_inc.php'; ?>
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-md-7 inputGroupContainer">
						<div class="input-group">
							...
							<input type="text" name="transaction_descr" class="form-control input-sm" placeholder="Transaction description" value="<?php if (isset($_POST['transaction_descr'])) echo @$transaction_descr; ?>" pattern=".{6,}" required />
						</div>
					</div>
				</div>
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
							<input type="text" id="quantity" name="quantity" class="form-control input-sm" placeholder="" value="<?php if (isset($_POST['quantity'])) echo @$quantity; ?>" maxlength="4" onBlur="loadCalc()" required />
						</div>
					</div>
				</div>
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							...
							<input type="text" name="receipt_no" class="form-control input-sm" placeholder="Receipt No" pattern="^\d{7}$" value="<?php if (isset($repost_id)) echo @$receipt_no; ?>" maxlength="7" onBlur="loadCalc()" required />
						</div>
					</div>
				</div>
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							...
							<input type="text" id="amount_paid" name="amount_paid" class="form-control input-sm" placeholder="Amount Remitted" value="<?php if (isset($repost_id)) echo @$amount_paid; ?>" maxlength="20" onBlur="loadCalc()" readonly />
						</div>
					</div>
				</div>
			...
			<tr>
				<td colspan="3" align="center">
					<div class="form-group form-group-sm">
						<div>
							<?php include 'payments_logged/submit_button_inc.php'; ?>	
						</div>
					</div>
				</td>
			</tr>
