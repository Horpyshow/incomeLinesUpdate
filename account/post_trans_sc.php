...
include ('controllers/post_trans_form_submit_inc_sc.php');
?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="container-fluid">
	<div class="col-md-12">
				...
				<div class="container-fluid">
					<div class="col-md-7">
						<h2>
							...
							<a href="post_new_lease_arena.php" class="btn btn-sm btn-success">New Lease (S/C)</a>
							<a href="post_past_trans_sc.php" class="btn btn-sm btn-danger">Past Postings (S/C)</a>
						</h2>
					</div>
		...
		<div class="row">
			<?php include ('controllers/post_trans_form_inc_sc.php'); ?>
		</div>
	</div>			
</div>
